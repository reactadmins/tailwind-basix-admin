...
export default [
  {
    ...
    component: ComponentCreator('/__docusaurus/debug', '027'),
    exact: true
  },
  {
    path: '/__docusaurus/debug/config',
    component: ComponentCreator('/__docusaurus/debug/config', '4a1'),
    exact: true
  },
  {
    path: '/__docusaurus/debug/content',
    component: ComponentCreator('/__docusaurus/debug/content', '3cf'),
    exact: true
  },
  {
  ...
  },
  {
    ...
    component: ComponentCreator('/__docusaurus/debug/metadata', 'ec2'),
    exact: true
  },
  {
    path: '/__docusaurus/debug/registry',
    component: ComponentCreator('/__docusaurus/debug/registry', 'cb1'),
    exact: true
  },
  {
  ...
  {
    path: '/old-index',
    component: ComponentCreator('/old-index', '6b3'),
    exact: true
  },
  {
    path: '/',
